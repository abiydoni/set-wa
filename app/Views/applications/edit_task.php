...
<div class="mb-8 flex items-center justify-between">
    <div class="flex items-center">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100"><?= lang('App.edit') ?></h1>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="task_name" value="<?= esc($task['task_name']) ?>" required placeholder="e.g. Daily Expired Report" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white">
                            </div>
                            <div class="space-y-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"><?= lang('App.wa_id') ?> <span class="text-red-500">*</span></label>
                                <input type="text" name="wa_id" value="<?= esc($task['wa_id']) ?>" required placeholder="Format: 628123xxx atau 1203xxx@g.us" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="task_type" id="task_type" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white">
                                <option value="sql" <?= ($task['task_type'] === 'sql') ? 'selected' : '' ?>>Database (SQL Query)</option>
                                <option value="php" <?= ($task['task_type'] === 'php') ? 'selected' : '' ?>>Custom PHP Script</option>
                            </select>
                        </div>

                        <!-- WADAH UNTUK PHP SCRIPT -->
                        <div id="php_container" style="display: <?= ($task['task_type'] === 'php') ? 'block' : 'none' ?>;" class="space-y-0">
                            ...
                            <div class="border border-t-0 border-gray-700 rounded-b-xl overflow-hidden">
                                <textarea name="php_script" id="php_script" class="hidden"><?= esc($task['php_script'] ?? '') ?></textarea>
                            </div>
                        ...
                        <div id="sql_container" style="display: <?= ($task['task_type'] === 'sql') ? 'block' : 'none' ?>;" class="space-y-6">
                            <div class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="custom_query" id="custom_query" rows="4" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-gray-50 dark:bg-gray-800 dark:text-white font-mono text-sm"><?= esc($task['custom_query']) ?></textarea>
                                </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="message_template" rows="2" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white font-mono text-sm"><?= esc($task['message_template']) ?></textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"><?= lang('App.body_msg') ?></label>
                                    <textarea name="body_message" rows="2" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white font-mono text-sm"><?= esc($task['body_message']) ?></textarea>
                                </div>
                                <div class="space-y-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300"><?= lang('App.footer_msg') ?></label>
                                    <textarea name="message_footer" rows="2" class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-dark-border focus:ring-2 focus:ring-primary focus:border-primary transition-colors bg-white dark:bg-gray-800 dark:text-white font-mono text-sm"><?= esc($task['message_footer']) ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pt-6 flex justify-end border-t border-gray-200 dark:border-dark-border">
                            ...
                            <button type="submit" class="px-8 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-xl font-medium shadow-md hover:shadow-lg transition-all flex items-center">
                                <i class="fa-solid fa-save mr-2"></i> Update Task
                            </button>
                        </div>
                    </form>
                </div>
...
(function() {
    ...
    // Refresh if initially visible
    if (taskTypeSelect.value === 'php') {
